function New-StringConversion {
    # Source: https://github.com/PsCustomObject/PowerShell-Functions/blob/master/New-StringConversion.ps1
    <#
        .SYNOPSIS
        ...
        .PARAMETER IgnoreSpaces
            By default spaces will be replaced with a dash '-' sign if parameter is specified function will not convert/take into consideration
...
Export-ModuleMember -Function New-StringConversion
