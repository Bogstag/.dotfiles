...
# class CascadiaCodeNFPropo : MyScoopApps {

#     CascadiaCodeNFPropo() : base(@{
#             Logo            = @"
# @@@@@@@%%%%##############%%%%@@@@@@@@@@@@@@@@@@@@@@@@%%%##############%%%@@@@@@@
# %%######*####%%%%%%%@@%%%%%#######%%%%%%%%%%%%%#######%%%%%%%%%%%%%%###**#####%%
# ########%@@@@@@@@@@@@%#%@@@@@@@%%#*##@@@@@@#*#*#%%@@@@@@@@@@@@@@%######%%#######
...
# "@
#             Name            = "CascadiaCode-NF-Propo"
#             Store           = "nerd-fonts"
#             VerifyFile      = "$Env:SCOOP\apps\CascadiaCode-NF-Propo\current\manifest.json"
